...
<html lang="en">
  ...
  <head>
    <title>Welcome | YSG Courier Services - Shipping, Freight Transportation and Logistics</title>
    <meta charset="utf-8">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <div class="top-bar">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <a href="#" class=""><span class="mr-2  icon-envelope-open-o"></span> <span class="d-none d-md-inline-block">ysgcourierservice4@gmail.com</span></a>
              <span class="mx-md-2 d-inline-block"></span>
              <a href="#" class=""><span class="mr-2  icon-phone"></span> <span class="d-none d-md-inline-block">+1(920) 395-8059</span></a>
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center text-center">
              <div class="col-lg-6">
                ...
                <p class="mb-5">We guarantee your goods to arrive their destinations while maintaining the environmental standard</p>
                <form action="{{url('track')}}" method="get">
                  <div class="form-group d-flex">
                    <input type="text" class="form-control" name="xx" placeholder="Your tracking number">
          ...
          <div class="container">
            <div class="owl-carousel owl-all">
              <div class="service text-center">
                <a href="#"><img src="images/depot_img_4.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
                  <h3><a href="#">Dropoff Depot</a></h3>
                  <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae distinctio laudantium nulla eos numquam incidunt!</p>
                </div>
              </div>
              <div class="service text-center">
                <a href="#"><img src="images/depot_img_5.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
                  <h3><a href="#">Secure Storage</a></h3>
                  <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae distinctio laudantium nulla eos numquam incidunt!</p>
                </div>
              </div>
              <div class="service text-center">
                <a href="#"><img src="images/depot_img_6.jpg" alt="Image" class="img-fluid"></a>
                <div class="px-md-3">
